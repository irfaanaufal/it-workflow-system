...
export default function RolesBriefing({ roles = [], userApps = [] }) {
    ...
    const handleRoleChange = (userAppId, newRoleId) => {
        ...
        router.patch(route('admin.users.update-briefing-role', userAppId), {
    ...
    return (
        ...
        >
            <Head title="Peran Pengguna Briefing/Meeting" />

            <div className="py-4">
                <div className="md:flex md:items-center md:justify-between mb-8">
                    <div className="flex-1 min-w-0">
                        <h2 className="text-2xl font-bold leading-7 text-gray-900 dark:text-white sm:text-3xl sm:truncate">
                            Peran Pengguna Briefing/Meeting
                        </h2>
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Atur peran pengguna khusus untuk sistem Briefing/Meeting secara terpisah.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-sm overflow-hidden transition-all duration-300">
                    {filtered.length === 0 ? (
                        <div className="text-center py-16">
                            ...
                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Belum ada pengguna yang memiliki akses ke sistem Briefing/Meeting.</p>
                        </div>
                    ) : (
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-zinc-900/60 border-b border-gray-150 dark:border-zinc-800 text-xs font-bold text-gray-550 dark:text-zinc-400 uppercase tracking-wider">
                                        ...
                                        <th className="py-4 px-6">Role Briefing/Meeting</th>
                                    </tr>
                                </thead>
