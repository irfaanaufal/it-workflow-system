                ...
                <div className="md:flex md:items-center md:justify-between mb-8">
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Daftar seluruh pengguna sistem beserta penetapan perannya secara terpusat.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-sm overflow-hidden transition-all duration-300">
                    {filteredUsers.length === 0 ? (
                        <div className="text-center py-16">
                            ...
                            <h3 className="mt-3 text-sm font-semibold text-gray-900 dark:text-white">Pengguna tidak ditemukan</h3>
                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Tidak ada nama pengguna yang sesuai dengan kata kunci pencarian.</p>
                        </div>
                    ) : (
