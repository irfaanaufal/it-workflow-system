        ...
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-zinc-900 px-6">
                <div className="text-center max-w-md">
                    <div className="text-8xl font-black text-gray-200 dark:text-zinc-800 mb-4">404</div>
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-zinc-100 mb-2">Halaman Tidak Ditemukan</h1>
